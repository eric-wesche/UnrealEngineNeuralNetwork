...
AUENeuralNetworkCharacter::AUENeuralNetworkCharacter()
{
...
void AUENeuralNetworkCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void AUENeuralNetworkCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AUENeuralNetworkCharacter::Move);

		//Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AUENeuralNetworkCharacter::Look);

	}

}

void AUENeuralNetworkCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AUENeuralNetworkCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
